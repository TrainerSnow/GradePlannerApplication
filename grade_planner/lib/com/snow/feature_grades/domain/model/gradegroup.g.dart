...
GradeGroup _$GradeGroupFromJson(Map<String, dynamic> json) => GradeGroup(
      ...
      grades: (json['grades'] as List<dynamic>).map((e) => Grade.fromJson(e as Map<String, dynamic>)).toList(),
    );

Map<String, dynamic> _$GradeGroupToJson(GradeGroup instance) => <String, dynamic>{
      'name': instance.name,
